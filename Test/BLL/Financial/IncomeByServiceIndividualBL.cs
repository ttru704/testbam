...
namespace Test.BLL.Financial
{
    public class IncomeByServiceIndividualBL : IDisposable
    {
        ...
        public List<usp_IncomeByServiceIndividual_Result> usp_IncomeByServiceIndividual(DateTime? start, DateTime? end, int? companyRef, long? productNumnber, int? timeType)
        {
