...
namespace Test.BLL.Customer
{
    public class AvgDollarPerCustomerBranchBL
    {
        ...
        public List<usp_AvgDollarPerCustomerBranch_Result> usp_AvgDollarPerCustomerBranch(DateTime? start, DateTime? end, long? companyRef, long? branchRef, int? timeType)
        {
