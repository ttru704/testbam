<%@ Page Title="" Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="userKpisForCFL.aspx.cs" Inherits="Test.userKpisForCFL" %>
            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    ...
                    <telerik:RadGrid runat="server" ID="KPIListForUserG1" CellSpacing="-1" GridLines="Both" DataSourceID="KPIListForUserODS1" OnSelectedCellChanged="kpiG1_SelectedCellChanged" Skin="MetroTouch">
                        ...
                        <MasterTableView EditMode="Batch" AutoGenerateColumns="False" CommandItemDisplay="None" DataSourceID="KPIListForUserODS1" ClientDataKeyNames="Kpi_For_Company">
                            <Columns>
                    ...
                    <asp:ObjectDataSource ID="KPIListForUserODS1" runat="server" SelectMethod="usp_KPIListForUser" TypeName="Test.BLL.Controls.KPIListForUserBL">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="CompanyDDL1" PropertyName="SelectedValue" Name="companyRef" Type="Int32"></asp:ControlParameter>
