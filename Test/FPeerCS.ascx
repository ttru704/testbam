...
<%--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Variations:
    - The Parameters to be selected for the peer comparison are put inside the Rad Panel Bar
    - These include: Branch, branch type, country, state and region
    - Stored in session via codebehind
        ...
        <Items>
            <telerik:RadPanelItem Width="100%">
                <ContentTemplate>
                    ...
                    <telerik:RadButton ID="GoButton" runat="server" Text="Go" Skin="Metro" CssClass="GoButton"></telerik:RadButton>
                    <br />
                </ContentTemplate>
        ...
        <Items>
            ...
            <telerik:RadPanelItem Text="Average Dollar per Transaction - Peer Comparison" Visible="false" Expanded="false">
                <ContentTemplate>
                    ...
                    <%--Datasource--%>
                    <asp:ObjectDataSource ID="AvgDollarPerTransactionPeerGridODS1" runat="server" SelectMethod="usp_AvgDollarPerTransactionPeerGrid" TypeName="Test.BLL.Financial.AvgDollarPerTransactionPeerGridBL">
                    ...
                    <hr />
                    <div class="padding">
                        <telerik:RadGrid ID="AvgDollarPerTransactionPeerGridG1" RenderMode="Lightweight" runat="server" DataSourceID="AvgDollarPerTransactionPeerGridODS1" AllowPaging="True" AllowSorting="True" ShowGroupPanel="True" OnItemCommand="ExportGridCustomiser" ExportSettings-FileName="Average Dollar per Transaction Peer Comparison">
                            <ClientSettings AllowDragToGroup="True" AllowColumnsReorder="True" ReorderColumnsOnClient="True">
                                <Selecting AllowRowSelect="True"></Selecting>
                            </ClientSettings>
                            <ExportSettings HideStructureColumns="true"></ExportSettings>
                            <MasterTableView Width="100%" CommandItemDisplay="Top" DataSourceID="AvgDollarPerTransactionPeerGridODS1" AllowFilteringByColumn="true" AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="YourBranch" SortExpression="YourBranch" UniqueName="YourBranch" DataType="System.Decimal" FilterControlAltText="Filter YourBranch column" HeaderText="Your Branch"></telerik:GridBoundColumn>
                                </Columns>
                            </MasterTableView>
