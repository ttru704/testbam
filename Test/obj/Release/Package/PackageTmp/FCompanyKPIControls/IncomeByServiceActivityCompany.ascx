<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IncomeByServiceActivityCompany.ascx.cs" Inherits="Test.FCompanyKPIControls.IncomeByServiceActivityCompany" %>
...
<div class="export">
    <%--Export chart button--%>
    <telerik:RadButton ID="IncomeByServiceActivityComEB" RenderMode="Lightweight" CssClass="ExportButton" runat="server" OnClientClicked="exportIncomeByServiceActivityComRHC1" Text="Export to PDF" AutoPostBack="false" UseSubmitBehavior="false"></telerik:RadButton>
    <%--Chart--%>
