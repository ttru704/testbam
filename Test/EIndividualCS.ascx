            ...
            <telerik:RadPanelItem Text="Number of Customers Seen By Employee" Expanded="False">
                <ContentTemplate>
                    ...
                    <div class="export">
                        ...
                        <telerik:RadHtmlChart ID="CustomersSeenByEmployeeIndividualRHC1" runat="server" CssClass="MonthlyExport1" Skin="Bootstrap">
            ...
            <telerik:RadPanelItem Text="Number of Animals Seen By Employee" Expanded="False">
                <ContentTemplate>
                    ...
                    <div class="export">
                        ...
                        <telerik:RadHtmlChart ID="AnimalsSeenByEmployeeIndividualRHC1" runat="server" Skin="Metro">
