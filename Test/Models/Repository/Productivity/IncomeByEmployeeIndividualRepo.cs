...
namespace Test.Models.Repository.Productivity
{
    public class IncomeByEmployeeIndividualRepo: IDisposable, IIncomeByEmployeeIndividualRepo
    {
        ...
        List<usp_IncomeByEmployeeIndividual_Result> IIncomeByEmployeeIndividualRepo.usp_IncomeByEmployeeIndividual(DateTime? start, DateTime? end, Int64? companyRef, long? staffNumber, int? timeType)
        {
