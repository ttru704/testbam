...
namespace Test.Models.Repository.Customer
{
    public class NewCustomersBranchRepo: IDisposable, INewCustomersBranchRepo
    {
        ...
        List<usp_NewCustomersBranch_Result> INewCustomersBranchRepo.usp_NewCustomersBranch(DateTime? start, DateTime? end, long? companyRef, long? branchRef, int? timeType)
        {
