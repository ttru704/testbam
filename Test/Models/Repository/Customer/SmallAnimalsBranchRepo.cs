...
namespace Test.Models.Repository.Customer
{
    public class SmallAnimalsBranchRepo : IDisposable, ISmallAnimalsBranchRepo
    {
        ...
        List<usp_SmallAnimalsBranch_Result> ISmallAnimalsBranchRepo.usp_SmallAnimalsBranch(DateTime? start, DateTime? end, long? companyRef, long? branchRef, int? timeType)
        {
