...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        <h4>Hi CFL, Create a new account</h4>
        <hr />
       ...
       <%-- <div class="form-group">
        ...
        <%--User inputs company's name --%>
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="companyNameTextbox" CssClass="col-md-2 control-label">Company name</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="companyNameTextbox" CssClass="form-control" TextMode="SingleLine" />
        ...
        <%--       User inputs Business type --%>
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="BusinessTypeTextbox" CssClass="col-md-2 control-label">Business type</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="BusinessTypeTextbox" CssClass="form-control" TextMode="SingleLine" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="BusinessTypeTextbox"
                    CssClass="text-danger" ErrorMessage="The business type field is required." />
            </div>
        </div>
