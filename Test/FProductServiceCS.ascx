...
<div class="demo-container size-thin">
    ...
    <telerik:RadPanelBar RenderMode="Lightweight" runat="server" ID="RadPanelBar1" Width="100%" Skin="MetroTouch">
        <Items>
            ...
            <telerik:RadPanelItem Text="Income By Service Activity" Expanded="false">
                <ContentTemplate>
                    ...
                    <div class="export">
                        ...
                        <telerik:RadHtmlChart ID="IncomeByServiceIndividualRHC1" runat="server" Skin="Material">
            ...
            <telerik:RadPanelItem Text="Income By Product" Expanded="false">
                <ContentTemplate>
                    ...
                    <div class="export">
                        ...
                        <telerik:RadHtmlChart ID="IncomeByProductIndividualRHC1" runat="server" Skin="Material">
                    ...
                    <br />
                    <br />
                    <telerik:RadGrid ID="IncomeByProductIndividualG1" runat="server" AllowPaging="True" AllowSorting="True" ShowGroupPanel="True" Skin="Metro" OnItemCommand="ExportGridCustomiser" DataSourceID="IncomeByProductIndividualODS1">
                        <ClientSettings AllowDragToGroup="True"></ClientSettings>
                        <ExportSettings HideStructureColumns="true"></ExportSettings>
            ...
            <telerik:RadPanelItem Text="Income by Product Category - Company" Expanded="false">
                <ContentTemplate>
                    <%--Chart--%>
                    <br />
                    <div class="export">
            ...
            <telerik:RadPanelItem Text="Income by Service Activity - Company" Expanded="false">
                <ContentTemplate>
